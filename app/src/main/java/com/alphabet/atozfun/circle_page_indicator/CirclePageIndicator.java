package com.alphabet.atozfun.circle_page_indicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		/*
		 * Drawable background =
		 * a.getDrawable(R.styleable.CirclePageIndicator_android_background); if
		 * (background != null) { setBackgroundDrawable(background); }
		 * 
		 * a.recycle();
		 */
